...
type EnrichedDoseHistory = DoseHistory & { 
...
export default function HistoryScreen() {
  ...
  const loadHistory = useCallback(async () => {
    try {      
      ...
      const enrichedHistory = doseHistory.map((dose) => {
        // Use scheduledTime for status calculation if available
        const statusTime = dose.scheduledTime || dose.timestamp;
        
        // For historical records, status is simply taken or missed
  ...
  const filteredHistory = history.filter((dose) => {
    ...
    return dose.status === selectedFilter;
  });
        ...
        <ScrollView style={styles.historyContainer} showsVerticalScrollIndicator={false}>
          {groupedHistory?.length ? (
                    ...
                    <View key={dose.id} style={styles.historyCard}>
                      ...
                      <View style={styles.medicationInfo}>
                        ...
                        <Text style={styles.medicationDosage}>
                          {dose.medication?.dosage || "Dosage not specified"}
                        </Text>
                        <Text style={styles.timeText}>
                          {convertToAmPm(dose.displayTime)}
                          {isMissed && " (Missed)"}
                        </Text>
                      </View>
            ...
            <View style={styles.nohistoryContainer}>
              ...
              <Text style={styles.nohistorySubtext}>Your medication history will appear here</Text>
            </View>
          )}
